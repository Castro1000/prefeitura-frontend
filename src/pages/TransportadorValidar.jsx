...
export default function TransportadorValidar() {
  ...
  const scanLockRef = useRef(false); // evita ler várias vezes
    ...
    try {
      ...
      const config = {
        ...
        qrbox: (vw, vh) => {
          ...
          const box = Math.floor(minEdge * 0.75);
  ...
  return (
    <>
      <style>{`
        ...
        /* força o vídeo do html5-qrcode a não dar zoom no Chrome */
        #qr-reader-transportador video {
          ...
          <div className="relative z-10 w-full max-w-sm mx-4 bg-white rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-4">
              ...
              <div className="text-xs text-gray-600 mt-2">
                Posicione o QR dentro da moldura. Se estiver muito embaçado,
